    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url() ?>/stock/add_barang_action" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="kode">Kode Barang</label>
                                    <input type="text" class="form-control" name="kode" id="kode" placeholder="Kode Barang" required value="<?= (old('kode')) ? old('kode') : '' ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nm_barang" id="nm_barang" placeholder="Nama Barang" required value="<?= (old('nm_barang')) ? old('nm_barang') : '' ?>">
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="kategori" id="kategori" required>
                                                ...
                                                <?php foreach ($cat as $c) : ?>
                                                    <option value="<?= $c->kd_cat ?>"<?= (old('kategori') && old('kategori') == $c->kd_cat) ? 'selected' : '' ?>><?= $c->kategori ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="jenis" id="jenis" required>
                                                ...
                                                <?php foreach ($jns as $j) : ?>
                                                    <option value="<?= $j->kd_jns ?>" <?= (old('jenis') && old('jenis') == $j->kd_jns) ? 'selected' : '' ?>><?= $j->jns ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="merk_id" id="merk_id" required>
                                                ...
                                                <?php foreach ($merk as $m) : ?>
                                                    <option value="<?= $m->id ?>" <?= (old('merk_id') && old('merk_id') == $m->id) ? 'selected' : '' ?>><?= $m->merk ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="satuan" id="satuan" required>
                                                ...
                                                <option value="PCS" <?= (old('satuan') && old('satuan') == 'PCS') ? 'selected' : '' ?>>PCS</option>
                                                <option value="KARTON" <?= (old('satuan') && old('satuan') == 'KARTON') ? 'selected' : '' ?>>KARTON</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="berat" id="berat" placeholder="Harga Barang" required value="<?= (old('berat')) ? old('berat') : '' ?>">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="stok">Stock Barang</label>
                                            <input type="number" class="form-control" name="stok" id="stok" placeholder="Stock Barang" required value="<?= (old('stok')) ? old('stok') : '' ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="harga">Harga Barang</label>
                                    <input type="number" class="form-control" name="harga" id="harga" placeholder="Harga Barang" required value="<?= (old('harga')) ? old('harga') : '' ?>">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="row mb-3 flex-column">
                                    ...
                                    <div class="col-sm-2">
                                        <img src="../assets/img/user/" alt="" class="img-thumbnail img-preview">
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="row mb-3 flex-column">
                                    ...
                                    <div class="col-sm-2">
                                        <img src="../assets/img/user/" alt="" class="img-thumbnail img-preview2">
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                ...
                                <div class="row mb-3 flex-column">
                                    ...
                                    <div class="col-sm-2">
                                        <img src="../assets/img/user/" alt="" class="img-thumbnail img-preview3">
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                ...
                                <div class="row mb-3 flex-column">
                                    ...
                                    <div class="col-sm-2">
                                        <img src="../assets/img/user/" alt="" class="img-thumbnail img-preview4">
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" name="ket" id="ket" cols="30" rows="20" placeholder="Keterangan" required><?= (old('ket')) ? old('ket') : '' ?></textarea>
                                </div>
                            </div>
                        </div>
