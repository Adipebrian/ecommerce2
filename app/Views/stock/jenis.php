                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Upload Jenis Barang</h3>
                        </div>
                        <!-- Flashdata -->
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= base_url() ?>/import_jenis" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="#" class="btn btn-success float-right" data-toggle="modal" data-target="#modal-add">Add Jenis Barang</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($result as $r) : ?>
                                        <tr>
                                            ...
                                            <td><?= $r->jns ?></td>
                                            <td>
                                                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal-edit<?= $r->kd_jns ?>">Edit</a>
                                                <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete<?= $r->kd_jns ?>">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<div class="modal fade" id="modal-add">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>/add_jenis" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
...
<!-- Modal -->
<?php foreach ($result as $r) : ?>
    <div class="modal fade" id="modal-edit<?= $r->kd_jns ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url() ?>/edit_jenis" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="modal-body">
                        <input type="hidden" value="<?= $r->kd_jns ?>" name="kode">
                        <div class="form-group">
                            <label for="jenis">Jenis Barang</label>
                            <input type="text" class="form-control" name="jenis" id="jenis" placeholder="Jenis Barang" required value="<?= $r->jns ?>">
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<?php endforeach; ?>
<?php foreach ($result as $r) : ?>
    <div class="modal fade" id="modal-delete<?= $r->kd_jns ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url() ?>/delete_jenis" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="modal-body">
                        <input type="hidden" value="<?= $r->kd_jns ?>" name="kode">
