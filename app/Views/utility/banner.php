                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal-add">Add Banner</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($result as $r) : ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                                            <td>
                                                <img src="<?= base_url() ?>/assets/img/banner/<?= $r->img; ?>" style="width: 100px; height:100px;" alt="" class="img-thumbnail img-preview">
...
<div class="modal fade" id="modal-add">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url() ?>/utility/banner_add" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="foto" class="col-sm-2 col-form-label">Image</label>
                        <div class="col-sm-2">
                            <img src="/assets/img/banner" alt="" class="img-thumbnail img-preview2">
                        </div>
                        <div class="col-sm-8">
    ...
    <div class="modal fade" id="modal-edit<?= $r->id ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>/utility/banner_edit" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="foto" class="col-sm-2 col-form-label">Image</label>
                            <div class="col-sm-2">
                                <img src="<?= base_url() ?>/assets/img/banner/<?= $r->img ?>" alt="" class="img-thumbnail img-preview3">
                            </div>
                            <div class="col-sm-8">
                                <div class="input-group mb-3">
    ...
    <div class="modal fade" id="modal-delete<?= $r->id ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>/utility/banner_delete" method="POST">
                    <?= csrf_field(); ?>
                    <div class="modal-body">
                        <input type="hidden" name="id" value="<?= $r->id ?>">
                        <input type="hidden" name="fotoLama" value="<?= $r->img ?>">
